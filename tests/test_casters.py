...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            ~st.String,
            lambda x: isinstance(x, casters.ForceCaster),
            id="str_nullable_to_nullable",
        ),
        pytest.param(
            bool, bool, lambda x: isinstance(x, casters.ForceCaster), id="bool"
        ),
        ...
        pytest.param(
            ...
            ~st.Boolean,
            lambda x: isinstance(x, casters.ForceCaster),
            id="bool_nullable_to_nullable",
        ),
        pytest.param(
            float, float, lambda x: isinstance(x, casters.ForceCaster), id="float"
        ),
        ...
        pytest.param(
            ...
            ~st.Float,
            lambda x: isinstance(x, casters.ForceCaster),
            id="float_to_nullable",
        ),
        pytest.param(
            ~st.Float,
            ~st.Float,
            lambda x: isinstance(x, casters.ForceCaster),
            id="float_nullable_to_nullable",
        ),
        pytest.param(
            st.Array[int],
            st.Array[int],
        ...
        pytest.param(
            ...
            ~st.Array[int],
            lambda x: isinstance(x, casters.ForceCaster),
            id="array_to_nullable",
        ),
        pytest.param(
            st.Array[int],
            st.Array[~st.Integer],
            lambda x: isinstance(x, casters.ForceCaster),
            id="array_null_element",
        ),
        pytest.param(
            st.Struct["a":int],
            st.Struct["a":int],
        ...
        pytest.param(
            st.Map[int, int],
            st.Map[~st.Integer, ~st.Integer],
            lambda x: isinstance(x, casters.ForceCaster),
            id="map_nullable_values",
        ),
        pytest.param(
            float, int, lambda x: isinstance(x, casters.ForceCaster), id="float_to_int"
        ),
        pytest.param(
            int,
            ~st.Float,
            lambda x: isinstance(x, casters.ForceCaster),
            id="int_to_nullable_float",
        ),
    ],
)
