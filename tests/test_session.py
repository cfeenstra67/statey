...
@pytest.mark.parametrize(
    "scope, result_key, result, edges",
    [
        pytest.param(
            set_items(lambda session, ref: {"a": 1, "b": ref("a", st.Integer) + 1}),
            "b",
            2,
            {("a", "b")},
            id="ref_int_1",
        ...
        pytest.param(
            set_items(
                lambda session, ref: {
                    ...
                    "b": {"a": ref("a", st.Integer), "other_attr": "Blah"},
                    "c": {
                        "c": ref("b.other_attr", st.Integer),
                        "d": st.str(ref("b.a", st.Integer)),
                    },
