...
@pytest.mark.parametrize(
    "func, result_key, result",
    [
        pytest.param(declarative_1, "a", 1, id="declarative_1"),
        pytest.param(declarative_2, "b", 2, id="declarative_2"),
        pytest.param(declarative_struct_1, "d", 6, id="declarative_struct_1"),
    ],
)
