...
@pytest.mark.parametrize('type, serialized', [
    pytest.param(int, {"type": "integer"}, id='int'),
    pytest.param(~st.Integer, {"type": "integer", "nullable": True}, id='int_nullable'),
    pytest.param(float, {"type": "number"}, id='float'),
    pytest.param(~st.Float, {"type": "number", "nullable": True}, id='float_nullable'),
    pytest.param(bool, {"type": "boolean"}, id='bool'),
    pytest.param(~st.Boolean, {"type": "boolean", "nullable": True}, id='bool_nullable'),
    pytest.param(str, {"type": "string"}, id='str'),
    pytest.param(~st.String, {"type": "string", "nullable": True}, id='str_nullable'),
    pytest.param(
        st.Array[str],
